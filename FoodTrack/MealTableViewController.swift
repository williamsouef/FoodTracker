...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Agrumes", photo: photo1, rating: 4) else {
            fatalError("Unable to instantiate meal1")
        }
         
        guard let meal2 = Meal(name: "Charcuterie", photo: photo2, rating: 5) else {
            fatalError("Unable to instantiate meal2")
        }
         
        guard let meal3 = Meal(name: "Green detox", photo: photo3, rating: 3) else {
            fatalError("Unable to instantiate meal2")
        }
